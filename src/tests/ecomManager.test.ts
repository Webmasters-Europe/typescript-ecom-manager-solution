...
// ===== 11. Invalid Discount Values (NEW TEST) =====
console.warn('=== Testing Invalid Discount Values ===');
console.log(applyDiscount(shirt.id, -10)); // Expecting error message
console.log(applyDiscount(shirt.id, 120)); // Expecting error message

// ===== 12. Automatic ID Generation (NEW TEST) =====
console.warn('=== Testing Automatic ID Generation ===');
const autoGeneratedProduct = addProduct(
  'Headphones',
  79.99,
  'electronics',
  25,
...
console.log(
  'Generated ID should not be undefined or empty:',
  autoGeneratedProduct.id
);
